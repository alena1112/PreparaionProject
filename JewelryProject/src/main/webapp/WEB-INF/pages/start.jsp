...
<div class="w3-top">
    <div class="w3-white w3-xlarge" style="max-width:1200px;margin:auto">
        ...
        <div class="w3-center w3-padding-16">Graceful Jewelry</div>
    </div>
</div>
...
<div class="w3-main w3-content w3-padding" style="max-width:1200px;margin-top:100px">
    ...
    <spring:form method="get" action="/start" modelAttribute="jewelryList">
        <div class="w3-row-padding w3-padding-16 w3-center" id="row1">
            <c:forEach items="${jewelryListRow1}" var="item" varStatus="status">
                <div class="w3-quarter">
                    <a href="#food" class="jewelry-item-class">
                        <img src="${pageContext.request.contextPath}/resources/w3images/${item.imageUrl}" alt="${item.name}"
                             style="width:100%">
                        <h3>${item.name}</h3>
        ...
        <div class="w3-row-padding w3-padding-16 w3-center" id="row2">
            <c:forEach items="${jewelryListRow2}" var="item" varStatus="status">
                <div class="w3-quarter">
                    <a href="#food" class="jewelry-item-class">
                        <img src="${pageContext.request.contextPath}/resources/w3images/${item.imageUrl}" alt="${item.name}"
                             style="width:100%">
